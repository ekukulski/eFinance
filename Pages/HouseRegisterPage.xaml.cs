...
namespace eFinance.Pages
{
    ...
    {
        private readonly string registerFile = FilePathHelper.GeteFinancePath("House.csv");
        private readonly string currentFile = FilePathHelper.GeteFinancePath("HouseCurrent.csv");
