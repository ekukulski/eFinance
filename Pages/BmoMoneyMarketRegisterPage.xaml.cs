...
namespace eFinance.Pages
{
    public partial class BmoMoneyMarketRegisterPage : ContentPage
    {
        ...
        private readonly string registerFile = FilePathHelper.GeteFinancePath("BMOMoneyMarket.csv");
        private readonly string currentFile = FilePathHelper.GeteFinancePath("BMOMoneyMarketCurrent.csv");
        private readonly string transactionsFile = FilePathHelper.GeteFinancePath("transactionsMoneyMarket.csv");
