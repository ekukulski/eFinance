...
namespace eFinance.Pages
{
    ...
    {
        private readonly string registerFile = FilePathHelper.GeteFinancePath("HealthPro.csv");
        private readonly string currentFile = FilePathHelper.GeteFinancePath("HealthProCurrent.csv");
