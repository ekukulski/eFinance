...
namespace eFinance.Pages
{
    ...
    {
        private readonly string registerFile = FilePathHelper.GeteFinancePath("CharlesSchwabContributory.csv");
        private readonly string currentFile = FilePathHelper.GeteFinancePath("CharlesSchwabContributoryCurrent.csv");
