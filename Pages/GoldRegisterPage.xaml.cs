...
{
    public partial class GoldRegisterPage : ContentPage
    {
        private readonly string registerFile = FilePathHelper.GetKukiFinancePath("Gold.csv");
        private readonly string currentFile = FilePathHelper.GetKukiFinancePath("GoldCurrent.csv");
        private readonly string categoryFile = FilePathHelper.GetKukiFinancePath("Category.csv");
        private readonly decimal openingBalance = OpeningBalances.Get("Gold");

        private readonly RegisterViewModel viewModel = new();

        public GoldRegisterPage()
        {
            InitializeComponent();
        ...
        private void LoadRegister()
        {
            ...
            var entries = RegisterService.LoadRegister<RegistryEntry>(
                ...
                new RegistryEntry
                {
                    Date = OpeningBalances.GetDate("Gold") ?? DateTime.Today.AddDays(-1),
