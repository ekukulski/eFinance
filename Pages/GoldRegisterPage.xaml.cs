...
namespace eFinance.Pages
{
    ...
    {
        private readonly string registerFile = FilePathHelper.GeteFinancePath("Gold.csv");
        private readonly string currentFile = FilePathHelper.GeteFinancePath("GoldCurrent.csv");
