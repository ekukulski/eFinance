...
namespace eFinance.Pages
{
    ...
    {
        private readonly string registerFile = FilePathHelper.GeteFinancePath("Midland.csv");
        private readonly string currentFile = FilePathHelper.GeteFinancePath("MidlandCurrent.csv");
