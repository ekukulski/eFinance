...
namespace eFinance.Pages
{
    ...
    {
        private readonly string registerFile = FilePathHelper.GeteFinancePath("NissanSentra.csv");
        private readonly string currentFile = FilePathHelper.GeteFinancePath("NissanSentraCurrent.csv");
