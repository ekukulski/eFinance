...
namespace eFinance.Pages
{
    ...
    {
        private readonly string registerFile = FilePathHelper.GeteFinancePath("CharlesSchwabRothIraPatti.csv");
        private readonly string currentFile = FilePathHelper.GeteFinancePath("CharlesSchwabRothIraPattiCurrent.csv");
