...
{
    public partial class CharlesSchwabRothIraPattiRegisterPage : ContentPage
    {
        private readonly string registerFile = FilePathHelper.GetKukiFinancePath("CharlesSchwabRothIraPatti.csv");
        private readonly string currentFile = FilePathHelper.GetKukiFinancePath("CharlesSchwabRothIraPattiCurrent.csv");
        private readonly string categoryFile = FilePathHelper.GetKukiFinancePath("Category.csv");
        private readonly decimal openingBalance = OpeningBalances.Get("CharlesSchwabRothIraPatti");
        ...
        private void LoadRegister()
        {
            ...
            var entries = RegisterService.LoadRegister<RegistryEntry>(
                ...
                new RegistryEntry
                {
                    Date = OpeningBalances.GetDate("CharlesSchwabRothIraPatti") ?? DateTime.Today.AddDays(-1),
        ...
        private async void EditButton_Clicked(object sender, EventArgs e)
        {
            if (RegisterCollectionView.SelectedItem is RegistryEntry selectedEntry)
            {
                ...
                // Save the change to CharlesSchwabRothIraPatti.csv
